...
int main()
{
	...
	// calculating no. of parity bits=p_n
	i=0;
	...
	//c_l=total bits=parity bits+data bits	
	c_l = p_n + n;

	//putting 0 in parity position & putting data bits in non-parity position
	j=k=0;
	for(i=0;i<c_l;i++)
	{
	...
	//puting the parity bits in their position 
	for(i=0;i<p_n;i++)
	{
